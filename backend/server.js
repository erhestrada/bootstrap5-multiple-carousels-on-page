...
db.serialize(() => {
  ...
  db.run('CREATE TABLE IF NOT EXISTS comments (id INTEGER PRIMARY KEY, clip_id TEXT, user_id INTEGER, comment TEXT, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE CASCADE)');
